...
public class FilterContactTypeAdapter extends RecyclerView.Adapter<FilterContactTypeAdapter.ViewHolder> {
    ...
    private final AsyncListDiffer<FilterContactTypeUi> differ;
    ...
    //static class ListDiffCallback implements ListDiffInterface<FilterContactTypeUi>  { //extends DiffUtil.ItemCallback<FilterContactTypeUi> {
    ...
    //        return this.hashCode() == other.hashCode(); // Сравнение по hashCode
    //    }
